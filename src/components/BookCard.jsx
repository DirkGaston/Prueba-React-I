const BookCard = ({ imgSrc, Title, Author, infoLink }) => {
  return (
    <div className="max-w-sm w-full bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 albumCard">
      <img className="rounded-t-lg albumCardImg" src={imgSrc} alt="cover" />

      <div className="p-5">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          {Title} <span className="font-normal">de</span> {Author}
        </h5>
